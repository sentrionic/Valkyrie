...
export const register = (body: RegisterDTO): Promise<AxiosResponse<AccountResponse>> =>
  request.post('/account/register', body);

export const login = (body: LoginDTO): Promise<AxiosResponse<AccountResponse>> => request.post('/account/login', body);
...
export const resetPassword = (body: ResetPasswordInput): Promise<AxiosResponse<AccountResponse>> =>
