...
export class Initial1618145049570 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "messages" ("id" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "text" text, "channelId" character varying, "userId" character varying, "attachmentId" character varying, CONSTRAINT "REL_a736df8790a3a7e283e0d4153e" UNIQUE ("attachmentId"), CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_6ce6acdb0801254590f8a78c08" ON "messages" ("createdAt") `);
        await queryRunner.query(`CREATE TABLE "attachments" ("id" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "url" text NOT NULL, "filetype" character varying(50) NOT NULL, "filename" character varying, CONSTRAINT "PK_5e1f050bcff31e3084a1d662412" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_8df7f2e80f016ffd718f52a084" ON "attachments" ("createdAt") `);
        ...
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "FK_a736df8790a3a7e283e0d4153ea" FOREIGN KEY ("attachmentId") REFERENCES "attachments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "messages" DROP CONSTRAINT "FK_a736df8790a3a7e283e0d4153ea"`);
